...
const PublicLayout = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-veriscan-light public-bg-grid font-sans text-gray-900 relative overflow-x-hidden selection:bg-veriscan-purple/30">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div>
                            ...
                            <p className="text-slate-400 text-sm">Blockchain-integrated digital forensics platform for academic integrity and cyber threat detection.</p>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-slate-400">
                                ...
                                <li><span className="text-purple-400">🎓 Academic Mode</span></li>
                                <li><span className="text-orange-400">🛡️ Cybersecurity Mode</span></li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div className="border-t border-slate-800 pt-8 text-center">
                        <p className="text-gray-400 text-sm font-medium">© 2026 VeriScan — Blockchain-Integrated Digital Forensics Platform</p>
                    </div>
                </div>
            </footer>
        </div>
